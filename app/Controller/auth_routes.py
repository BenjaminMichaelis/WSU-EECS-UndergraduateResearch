...
def login():
    ...
    if lform.validate_on_submit():
        ...
        if (user.major is None) or (user.gpa is None) or (user.graduationDate is None) or (user.experience is None) or (user.electiveCourses is None) or (user.LanguagesKnown is None) or (user.Fields is None):
